...
echo "Creating GitHub issues for ClassCrawler..."
echo "=========================================="
echo ""

# Wave 1 Issues

echo "Creating Wave 1 issues..."
...
echo ""
echo "Wave 2 issues created successfully!"
echo ""

# Wave 3 Issues

echo "Creating Wave 3 issues..."

gh issue create \
  --repo "$REPO" \
  --title "[3pts] Implement SqliteGameRepository" \
  --label "wave-3,difficulty-3" \
  --body "## Description
...
echo ""
echo "Wave 3 issues created successfully!"
echo ""
echo "=========================================="
echo "All GitHub issues created successfully!"
echo "Total: 18 issues (5 Wave 1, 8 Wave 2, 5 Wave 3)"
echo "=========================================="
